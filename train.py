...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='C:/Users/Mr.Q/PycharmProjects/cf/cs/yolov5-master/models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default= 'C:/Users/Mr.Q/PycharmProjects/cf/cs/yolov5-master/data/mydata.yaml', help='dataset.yaml path')
